...
Run with::
    ...
    python3 -m workflows.code_review <command> [--json]

or directly::

    python3 /path/to/hermes-relay/workflows/code_review/__main__.py <command>
...
:func:`workflows.code_review.workspace.load_workspace_from_config`. It then
delegates dispatch to :func:`workflows.code_review.cli.main`.
